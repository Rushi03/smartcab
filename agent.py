...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=True, epsilon=0.85, alpha=0.5):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            """ Pick a decay function:
                epsilon = a ** t, 0 < a < 1
                epsilon = exp(-a * t), 0 < a < 1
                epsilon = 1 / (t ** 2)
                epsilon = cos(a * t), 0 < a < 1 """

            # Make a: 0 < a < 1
            a = 0.95
            self.epsilon = a ** self.counter
    ...
    def learn(self, state, action, reward):
        ...
        """ Q-Learning equation:
            Q(s,a) <- Q(s,a) {old value/current state} + alpha * (reward + gamma
            * argmaxQ(s,a){new value/next state} - Q(s,a){old value/current state})
            We aren't applying the discount factor for this problem so consider
            gamma = 0. """
